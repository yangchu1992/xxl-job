...
public class DingDingJobAlarm implements JobAlarm {
    ...
    private static final Logger logger = LoggerFactory.getLogger(DingDingJobAlarm.class);
    ...
    public boolean doAlarm(XxlJobInfo info, XxlJobLog jobLog) {
        ...
        if (info != null && ObjectUtils.nullSafeEquals(AlarmTypeEnum.DING_DING.getAlarmType(), info.getAlarmType()) && info.getAlarmUrl() != null && info.getAlarmUrl().trim().length() > 0) {
